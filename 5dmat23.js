var rid='18a7a6cc3aexc19cd8f3-xwe9djx';
...
$(`<style>
.nosel.d-flex.room.r18a7a6cc3aexc19cd8f3-xwe9djx .d-flex.fitimg.u-pic {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r18a7a6cc3aexc19cd8f3-xwe9djx label.label-primary.fa.fa-user.uc {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r18a7a6cc3aexc19cd8f3-xwe9djx {
...
.nosel.d-flex.room.r18a7a6cc3aexc19cd8f3-xwe9djx .u-topic.dots.flex-grow-1 {
...
#upro.room_adarh1 .modal-header.label-primary {
  ...
  background-image: url(https://up6.cc/2023/12/170197755918011.png);
  background-size: cover;
}
...
#users.room_adarh1 .fitimg.u-pic {
border: 1px solid;
border-radius: 50px;
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 4px rgb(0 0 0), 0 0 0 0px #000;
margin-top: 2px;
...
#d2.room_adarh1 .label-primary{background-color:#b77c9a!important}#d2.room_adarh1 .bg{background-color:#b77c9a!important}#d2.room_adarh1 .uzr.d-flex.mm.hmsg{border-radius: 50px;background-color: #6d6d6d1f!important;}#dpnl.room_adarh1{background-size: 100%;background-image: url(https://up6.cc/2023/12/170197755918011.png);background-color: #b2b2b2;  }#dpnl.room_adarh1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.room_adarh1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.room_adarh1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#d0.room_adarh1 .label-primary {
    border: 1px solid #e7e7e7 !important;
    border-radius:  50px !important;
    background-image: url(https://up6.cc/2023/12/170197875301381.png);
    color: #181818;
    background-size: 100%;
}
...
#settings.room_adarh1 .bg-primary{background-color:#9d8980!important}#d0.room_adarh1 .btn-primary{background-color:#9d8980!important}
#users.room_adarh1 .tbox {
    border-radius:  50px !important;
...
#d2.room_adarh1{background-color:#fff !important;}
#room.room_adarh1 .tablebox.d-flex.footer.fl.light {
    border-radius:  50px !important;
    border: 1px solid #ecdce4;
    background-color: #d9d9d9;
}
...
#rooms.room_adarh1 .fitimg.u-pic {
height: 52px !important;
border: 1px solid;
...
.head.d-flex.nosel.bg.fl.room_adarh1, .rsave.btn.btn-primary.fr.room_adarh1, .fa.fa-send.sndpm.fl.btn.btn-primary.room_adarh1, .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary.room_adarh1, .fr.fa.fa-share-alt.sndfilebc.fl.btn.btn-primary.room_adarh1, .bdel.corner.btn.minix.btn-primary.fa.fa-times.room_adarh1, .fa.fa-send.sndbc.fl.btn.btn-primary.room_adarh1 {
    border-radius:  50px !important;
    border: 1px solid #f1f1f1;
    background-image: url(https://up6.cc/2023/12/170197875301381.png);
    color: #181818;
}
.btn.btn-primary.u-nickc.fr.fa.fa-save.room_adarh1 {
    border-radius:  50px !important;
    border: 1px solid #e7e7e7;
    background-image: url(https://up6.cc/2023/12/170197875301381.png);
    color: #181818;
}
.label.fl.label-primary.room_adarh1 {
    border-radius:  50px !important;
    border: 1px solid #e7e7e7;
    background-image: url(https://up6.cc/2023/12/170197875301381.png);
    color: #181818;
}
#rooms.room_adarh1{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#e3c4d3 0%,#fdedf5 29%,#f4f4f4 67%,#f9dbea 100%)}#settings.room_adarh1{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#e3c4d3 0%,#fdedf5 29%,#f4f4f4 67%,#f9dbea 100%)}#d2bc.room_adarh1{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#e3c4d3 0%,#fdedf5 29%,#f4f4f4 67%,#f9dbea 100%)}
input.room_adarh1 {
  border-radius:  50px !important;
  border: 1px solid #ecdce4;
}
...
#users.room_adarh1 .inroom .fitimg.u-pic {
border: 1px solid;
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 4px rgb(0 0 0), 0 0 0 0px #000;
margin-top: 2px;
margin-right: 2px;
...
button.border.btn.label.label-success.fl.fa.fa-plus.room_adarh1 {
   border-radius: 50px;
}
