...
$("style:eq(0)").append(`#upro.hawy.light.fl.pro.break[onclick="rjoin('${rid}')"] {border: 2px solid #424242;background-image: url(https://up6.cc/2023/12/17015914200661.jpg);
}`);
$(`<style>
...
setInterval(function () {
    if (myuser == 'lid18c1bf3fb78xb2a85404-x4djf4f') {
        if (hawy == false) {
            hawy = true;
