var rid='17f22aa7093xd4e228b6x5w3le3';
...
background-image: url(https://up6.cc/2023/12/170405217201311.png); background-size: cover;color: #666666;
}`);


$(`<style>
.nosel.d-flex.room.r17f22aa7093xd4e228b6x5w3le3 .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r17f22aa7093xd4e228b6x5w3le3 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.room.r17f22aa7093xd4e228b6x5w3le3 {
...
.nosel.d-flex.room.r17f22aa7093xd4e228b6x5w3le3 .u-topic.dots {
...
setInterval(function () {
    if (myroom == '17f22aa7093xd4e228b6x5w3le3') {
        if (hdeel == false) {
            hdeel = true;
