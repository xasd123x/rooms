...
#upro.suukra1 .modal-header.label-primary {
  border-radius:  10px 0 10px!important;
...
#d2.suukra1 .label-primary{background-color:#b77c9a!important}#d2.suukra1 .bg{background-color:#b77c9a!important}#d2.suukra1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #6d6d6d1f!important;}#dpnl.suukra1{background-size: 100%;box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 5px rgb(0 0 0), 0 0 0 0px #000000;background-image: url(https://up6.cc/2024/02/170828016451151.png);background-color: #b2b2b2;  }#dpnl.suukra1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.suukra1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.suukra1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#users.suukra1 img.co{border-radius:  10px 0 10px!important;transform:rotate(0deg);margin-top:2px!important}
#users.suukra1 .nosel.ninr.fl.uzr.label.bg {
    border-radius:  10px 0 10px!important;
    box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 5px rgb(0 0 0), 0 0 0 0px #000000;
...
#d0.suukra1 .nosel.fl .bg{background-image:linear-gradient(225deg,#ce96b3 0%,#d091b1 29%,#eec6da 67%,#b77c9a 100%)}#d0.suukra1 .bg-primary{background-image:linear-gradient(225deg,#ce96b3 0%,#d091b1 29%,#eec6da 67%,#b77c9a 100%)}#d2.suukra1 .label-primary{background-image:linear-gradient(225deg,#ce96b3 0%,#d091b1 29%,#eec6da 67%,#b77c9a 100%)}
#room.suukra1 .btn-primary {
    border-radius:  10px 0 10px!important;
...
#room.suukra1 .tablebox.d-flex.footer.fl.light {
    border-radius:  10px 0 10px!important;
    border: 1px solid #ecdce4;
    background-color: #cab7bb;
}
#upro.suukra1 .light.fl.pro.break {
...
#wall.suukra1 .d-flex.fitimg.u-pic {
height: 52px !important;
border: 1px solid;
border-radius: 10px 0 10px;
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 4px rgb(0 0 0), 0 0 0 0px #000;
...
#rooms.suukra1 .d-flex.fitimg.u-pic{
height: 52px !important;
border: 1px solid;
...
.corner.border.label.label-primary.suukra1 {
  border-radius:  10px 0 10px!important;
  border: 1px solid #ecdce4;
  background-image: url(https://up6.cc/2024/02/170828016451151.png);
  background-size: cover;
}
.modal-header.label-primary.suukra1 {
	border-radius:  10px 0 10px!important;
    border: 1px solid #ecdce4;
    background-color: #b2b2b2!important;
	background-image: url(https://up6.cc/2024/02/170828016451151.png);
...
.head.d-flex.nosel.bg.fl.suukra1, .rsave.btn.btn-primary.fr.suukra1, .fa.fa-send.sndpm.fl.btn.btn-primary.suukra1, .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary.suukra1, .fr.fa.fa-share-alt.sndfilebc.fl.btn.btn-primary.suukra1, .bdel.corner.btn.minix.btn-primary.fa.fa-times.suukra1, .fa.fa-send.sndbc.fl.btn.btn-primary.suukra1 {
    border-radius:  10px 0 10px!important;
    border: 1px solid #f1f1f1;
    background-image: url(https://up6.cc/2024/02/170828016452992.png);
    color: #ffffff;
...
#users.suukra1 .inroom .fitimg.u-pic {
border: 1px solid;
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 4px rgb(0 0 0), 0 0 0 0px #000;
margin-top: 2px;
margin-right: 2px;
...
button.blike.corner.btn.minix.btn-danger.fa.fa-heart.suukra1 {
   border-radius: 10px 0 10px;
}
button.border.btn.label.label-success.fl.fa.fa-plus.suukra1 {
   border-radius: 10px 0 10px;
}
button.rsave.btn.btn-primary.fl.suukra1 {
   background-image: url(https://up6.cc/2024/02/170828016451151.png);
   background-size: cover;
   border-radius: 10px 0 10px;
}
